...
kamu bebas mengirim menfess pada channel Xtafes, jika ingin memposting menfess silahkan kirim pesan teks beserta tag dibawah ini :
...
def awikwokbanget(cek, cekin):
	...
	miaw.add(b1, b2)
	return miaw
print("\n\nBOT TELAH AKTIF!!! @RAINGERPROJECT")
